...
public class Doodle_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_select_image).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImageSelectorActivity.startActivityForResult(REQ_CODE_SELECT_IMAGE, Doodle_Activity.this, null, false);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SELECT_IMAGE) {
            ...
            if (list != null && list.size() > 0) {
                ...
                // 启动涂鸦页面
                DoodleActivity.startActivityForResult(Doodle_Activity.this, params, REQ_CODE_DOODLE);
            }
